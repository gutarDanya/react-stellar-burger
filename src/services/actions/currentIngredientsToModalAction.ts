...
export const ORDER_MODAL_WINDOW_OPENED: 'ORDER_MODAL_WINDOW_OPENED' = 'ORDER_MODAL_WINDOW_OPENED';

export const getCurrentOrderToModal = (order: any) => {
    return {type: ORDER_MODAL_WINDOW_OPENED, payload: order}
}
...
interface IgetCurrentOrderGenerator {
